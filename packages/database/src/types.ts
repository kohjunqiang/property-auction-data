...
export type CredsStatus = "failed" | "unknown" | "working";
...
export type ListingStatus = "ACTIVE" | "CALLED_OFF" | "RESERVED";

export type Numeric = ColumnType<string, number | string, number | string>;

export type StorageBuckettype = "ANALYTICS" | "STANDARD" | "VECTOR";

export type Tenure = "FREEHOLD" | "LEASEHOLD" | "NONE";
...
export interface Listings {
  ...
  id: string;
  land_area: Numeric;
  land_area_unit: Generated<string>;
  market_value: Numeric;
  price: Numeric;
  registered_investor: Generated<number>;
...
export interface PgmqAScrapeQueue {
...
export interface PgmqAScrapeQueueLocal {
  archived_at: Generated<Timestamp>;
  enqueued_at: Generated<Timestamp>;
  headers: Json | null;
  message: Json | null;
...
export interface PgmqQScrapeQueue {
  enqueued_at: Generated<Timestamp>;
  headers: Json | null;
  message: Json | null;
...
export interface PgmqQScrapeQueueLocal {
  enqueued_at: Generated<Timestamp>;
  headers: Json | null;
  message: Json | null;
  msg_id: Generated<Int8>;
...
export interface Users {
  ...
  created_at: Generated<Timestamp>;
  creds: Json | null;
  creds_encrypted: Generated<boolean>;
  creds_status: Generated<CredsStatus>;
  creds_status_updated_at: Timestamp | null;
  email: string;
  id: string;
  updated_at: Generated<Timestamp>;
}
...
export interface DB {
  ...
  listings: Listings;
  "pgmq.a_scrape-queue": PgmqAScrapeQueue;
  "pgmq.a_scrape-queue-local": PgmqAScrapeQueueLocal;
  "pgmq.meta": PgmqMeta;
  "pgmq.q_scrape-queue": PgmqQScrapeQueue;
  "pgmq.q_scrape-queue-local": PgmqQScrapeQueueLocal;
